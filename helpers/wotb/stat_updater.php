...
$account_ids_query = mysql_query("SELECT $wotb_accounts_account_id FROM $wotb_accounts_table");
while ($row = mysql_fetch_array($account_ids_query)) {
    $account_id = $row[$wotb_accounts_account_id];
    ...
    mysql_query("INSERT INTO $wotb_accounts_stat_table VALUES ('$account_id', '$clan_id', '$KPD', '$WN6', '$WN7', '$battles', '$wins_percent_rounded', '$joint_victory', '$solo_wins', '$avg_damage_dealt_rounded', '$avg_frags_rounded', '$avg_spotted_rounded', '$avg_hits', '$survival_percent_rounded', '$avg_xp_rounded', '$avg_shots', '$avg_hits', '$stat_date')");
}
